...
import static com.ververica.cdc.cli.encryptor.RSAConfigShade.ENCRYPTOR_PRIVATE_KEY_FORMAT;
import static com.ververica.cdc.cli.encryptor.RSAConfigShade.ENCRYPTOR_PRIVATE_KEY_LOCATION;
import static com.ververica.cdc.cli.encryptor.RSAConfigShade.ENCRYPTOR_PRIVATE_KEY_STRING;
import static com.ververica.cdc.cli.encryptor.RSAConfigShade.SECRET_ENCRYPTOR_PRIVATE_KEY_STRING;

/** Test RSA ConfigShade. */
public class RSAConfigShadeTest implements ConfigShade {
    public static final Logger LOG = LoggerFactory.getLogger(RSAConfigShadeTest.class);
