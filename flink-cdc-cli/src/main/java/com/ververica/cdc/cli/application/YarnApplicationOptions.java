...
import com.ververica.cdc.common.configuration.description.InlineElement;

import java.util.List;

import static com.ververica.cdc.cli.application.YarnApplicationOptions.UserJarInclusion.ORDER;
import static com.ververica.cdc.common.configuration.ConfigOptions.key;
import static com.ververica.cdc.common.configuration.description.LinkElement.link;
import static com.ververica.cdc.common.configuration.description.TextElement.code;
import static com.ververica.cdc.common.configuration.description.TextElement.text;

/**
 * Ref: {@link org.apache.flink.yarn.configuration.YarnConfigOptions}, DeploymentOptions his class
 * holds configuration constants used by Flink's YARN runners. These options are not expected to be
 * ever configured by users explicitly.
 */
public class YarnApplicationOptions {
    public static final String CLASS_NAME = "com.ververica.cdc.cli.CliFrontend";
                    ...
                    .withDescription(
                            Description.builder()
                                    ...
                                    .text(
                                            ...
                                            code("bin/flink run-application"))
    ...
    // custom added
    public static final ConfigOption<String> APPLICATION_LOG_CONFIG_DIR =
            key("yarn.log-config-dir")
                    .stringType()
                    .noDefaultValue()
                    .withDescription(
                            "The directory for the log config file, e.g. the directory where your log4j.properties for log4j is located.");
    ...
    public enum UserJarInclusion implements DescribedEnum {
        ...
        public org.apache.flink.configuration.description.InlineElement getDescription() {
            return (org.apache.flink.configuration.description.InlineElement) description;
        }
    }
}
