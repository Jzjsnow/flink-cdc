...
package com.ververica.cdc.cli.encryptor.util;
 ...
 *
 * <p>Ref: org.springframework.util.StringUtils
 */
public abstract class StringUtils {
    ...
    /**
     * Check whether the given object (possibly a {@code String}) is empty. This is effectively a
     ...
     *
     * <p><b>Note: If the object is typed to {@code String} upfront, prefer {@link
     * #hasLength(String)} or {@link #hasText(String)} instead.</b>
     *
     * @param str the candidate object (possibly a {@code String})
     * @since 3.2.1
     * @deprecated as of 5.3, in favor of {@link #hasLength(String)} and {@link #hasText(String)}
     *     (or {ObjectUtils.isEmpty(Object)})
     */
    @Deprecated
    ...
    /**
     * Trim <em>all</em> whitespace from the given {@code CharSequence}: leading, trailing, and in
     * between characters.
     *
    ...
    /**
     * Trim <em>all</em> whitespace from the given {@code String}: leading, trailing, and in between
     * characters.
     *
     * @param str the {@code String} to check
     * @return the trimmed {@code String}
     ...
     *
     * <p><strong>NOTE</strong> that {@code cleanPath} should not be depended upon in a security
     * context. Other mechanisms should be used to prevent path-traversal issues.
     *
     ...
     * Locale#toString} format as well as BCP 47 language tags as specified by {@link
     ...
     *     underscores), or BCP 47 (e.g. "en-UK")
     ...
     * considered as a single delimiter string, rather than as a bunch of potential delimiter
    ...
    public static String collectionToDelimitedString(
        ...
        int totalLength =
                coll.size() * (prefix.length() + suffix.length())
     ...
     *
     * <p>Delegates to {@link #truncate(CharSequence, int)}, supplying {@code 100} as the threshold.
     *
     * @param charSequence the {@code CharSequence} to truncate
     * @return a truncated string, or a string representation of the original {@code CharSequence}
     ...
     * Truncate the supplied {@link CharSequence}.
     *
     * <p>If the length of the {@code CharSequence} is greater than the threshold, this method
     * returns a {@linkplain CharSequence#subSequence(int, int) subsequence} of the {@code
     * CharSequence} (up to the threshold) appended with the suffix {@code " (truncated)..."}.
     * Otherwise, this method returns {@code charSequence.toString()}.
     *
     * @param charSequence the {@code CharSequence} to truncate
