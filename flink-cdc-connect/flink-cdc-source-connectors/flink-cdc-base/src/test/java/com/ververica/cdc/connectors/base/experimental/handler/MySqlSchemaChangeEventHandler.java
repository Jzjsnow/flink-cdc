...
public class MySqlSchemaChangeEventHandler implements SchemaChangeEventHandler {
    ...
    public Map<String, Object> parseSource(SchemaChangeEvent event) {
        ...
        String fileName = sourceInfo.getString(BinlogOffset.BINLOG_FILENAME_OFFSET_KEY);
        Long pos = sourceInfo.getInt64(BinlogOffset.BINLOG_POSITION_OFFSET_KEY);
        Long serverId = sourceInfo.getInt64(BinlogOffset.SERVER_ID_KEY);
        source.put(BinlogOffset.SERVER_ID_KEY, serverId);
        source.put(BinlogOffset.BINLOG_FILENAME_OFFSET_KEY, fileName);
        source.put(BinlogOffset.BINLOG_POSITION_OFFSET_KEY, pos);
        return source;
    }
}
