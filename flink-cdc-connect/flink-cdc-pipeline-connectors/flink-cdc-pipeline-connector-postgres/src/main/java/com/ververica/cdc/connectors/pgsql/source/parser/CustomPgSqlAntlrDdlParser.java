...
package com.ververica.cdc.connectors.pgsql.source.parser;
...
public class CustomPgSqlAntlrDdlParser extends MySqlAntlrDdlParser {

    private final LinkedList<SchemaChangeEvent> parsedEvents;

    public CustomPgSqlAntlrDdlParser() {
        super();
    ...
    protected AntlrDdlParserListener createParseTreeWalkerListener() {
        return new CustomPgSqlAntlrDdlParserListener(this, parsedEvents);
    }
