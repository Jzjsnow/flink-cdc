...
import com.ververica.cdc.connectors.pgsql.source.parser.CustomPgSqlAntlrDdlParser;
...
public class PostgresEventDeserializer extends DebeziumEventDeserializationSchema {
    ...
    protected List<SchemaChangeEvent> deserializeSchemaChangeRecord(SourceRecord record) {
        if (includeSchemaChanges) {
            if (customParser == null) {
                customParser = new CustomPgSqlAntlrDdlParser();
                tables = new Tables();
            }
    ...
    protected Object convertToString(Object dbzObj, Schema schema) {
        // the Geometry datatype in PgSQL will be converted to
